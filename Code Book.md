...
Experiment has been carried out with 30 volunteers within age bracket 19-48. Each person performed Six activities (WALKING, WALKING_UPSTAIRS, 
WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING). Various data generated by sensors is captured and recorded. The obtained dataset has been 
...
1.  X_train.txt: Data measurements from subjects in the training population. There are 7352 rows, 561 columns. Columns are labeled V1..V561
...
Tidy databaset was generated with average of mean and std deviation variables for each activity and each subject.
Here is how typical output looks like for subject 1 with activity of laying. Total 180 such observations are created in the tidy file.
